...
public class userEverySongsTimeAndTimes {
    ...
    public userEverySongsTimeAndTimes(Integer id, Integer userId, Integer songId, Integer songsCount, Integer playStartTime, Integer timeCount, String songName, Integer artistId, String artistName, Integer albumId, String albumName) {
        this.id=id;
        this.userId = userId;
        this.songId = songId;
